...
\newcommand{\placelastupdatedtext}{% \placetextbox{<horizontal pos>}{<vertical pos>}{<stuff>}
  \AddToShipoutPictureFG*{% Add <stuff> to current page foreground
    \put(
        ...
        \small\color{gray}\textit{Last updated in July 2025}\hspace{\widthof{Last updated in December 2024}}
    }}}%
  }%
}%
...
\begin{document}
    ...
    \begin{header}
        ...
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{https://omarabedelkader.github.io/}{\color{black}{\footnotesize\faLink}\hspace*{0.13cm}omarabedelkader.fr}}%
    \end{header}
    ...
    \section{About Me}  
        \begin{onecolentry}
            ...
            I am currently pursuing a Ph.D. in Computer Science at the University of Lille. \end{onecolentry}
        \vspace{0.2 cm}
...
% %%%%%%%%%%%%%%%%%%%%%%% PROJECTS
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item ChatPharo is an intelligent conversational assistant integrated into the Pharo IDE. It allows developers to interact with their environment using natural language. More than just a chat interface, ChatPharo can dynamically query and execute information in the development environment, leveraging system tools and AI to assist and accelerate software development in Pharo..
            \end{highlights}
            \begin{itemize}
                \item \textbf{GitHub Repository}: \href{https://github.com/omarabedelkader/ChatPharo}{GitHub}
              \end{itemize}              
        \end{onecolentry}
        \vspace{0.2 cm}
...
%             \textit{Sept. 2023 – Jan. 2024}}
%                 \textbf{Family Dynamics Analysis}
...
%         \begin{onecolentry}
%             \begin{highlights}
%                 \item  This project analyzes family dynamics in France using Formal Concept Analysis (FCA). By leveraging data from the French national census, the study identifies patterns in family structures, single-parent households, childbearing decisions, and naturalization through marriage across five regional zones. Using advanced data mining techniques, the project explores relationships between demographic variables such as marital status, household composition, and nationality, offering insights into the cultural and social trends shaping French households.
%             \end{highlights}
%             \begin{itemize}
%                 \item \textbf{GitHub Repository}: \href{https://github.com/omarabedelkader/FCA}{GitHub}
%                 \item \textbf{Paper}: \href{https://github.com/omarabedelkader/FCA/blob/main/paper/paper.pdf}{Paper}
%               \end{itemize}              
%         \end{onecolentry}
%         \vspace{0.2 cm}
...
%%%%%%%%%%%%%%%%%%%%%%% Talks
    ...
    \section*{Talks}
        \begin{onecolentry}
            \textbf{ChatPharo:} An Open Architecture for Understanding How to Talk Live to LLMs, ESUG 2025 \\ 
            \textbf{Presentation:} \href{https://archive.esug.org/ESUG2025/day4/407-abed-chatpharo.pdf}{Slides} \\ 
            \textbf{Video:} \textit{Coming soon}
        \end{onecolentry}
...
\section*{Mentorship}
\begin{onecolentry}
\textbf{Google Summer of Code (GSoC)}, Mentor \\ \href{https://gsoc.pharo.org/LLMInterface}{Project Link}
\end{onecolentry}
...
\section{Technologies \& Skills}     
    ...
    \begin{onecolentry}
        \textbf{Machine Learning \& Deep Learning:} TensorFlow, PyTorch, Keras, Scikit-learn
    \end{onecolentry}
    \vspace{0.2 cm}
...
\section{Visibility \& Testimonials}     
    \begin{onecolentry}
        \textbf{Alumni Testimonial — IDMC, University of Lorraine:} Featured on the official website of the \href{https://idmc.univ-lorraine.fr/temoignage-alumni-master-tal-omar/}{IDMC Institute} as an alumni in Natural Language Processing and Artificial Intelligence, sharing my academic and professional journey from MSc to PhD.
    \end{onecolentry}
