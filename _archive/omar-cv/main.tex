...
\begin{document}
    ...
    \section{About Me}  
        \begin{onecolentry}
            ...
            Currently pursuing a Ph.D. in Computer Science at the University of Lille. \end{onecolentry}
        \vspace{0.2 cm}
...
%%%%%%%%%%%%%%%%%%%%%%% SKILLS
    ...
    \section{Technologies \& Skills}     
        ...
        \begin{onecolentry}
            \textbf{Frameworks \& Tools:} Flaks, Django, MongoDB, Laravel, ReactJS, AWS, PyCharm, 
        \end{onecolentry}
        \vspace{0.2 cm}
        ...
        \begin{onecolentry}
            \textbf{Research Areas:} Artificial Intelligence, Software Engineer
        \end{onecolentry}
